...
nvcc -DTHRUST_IGNORE_CUB_VERSION_CHECK -dc -gencode arch=compute_60,code=sm_60 -gencode arch=compute_61,code=sm_61 -gencode arch=compute_61,code=sm_70  -g -O3 -w  -I../../rt/include -I../../rt/include/mgpu/include  -I../../rt/include/cub kernel.cu  -o kernel.o
